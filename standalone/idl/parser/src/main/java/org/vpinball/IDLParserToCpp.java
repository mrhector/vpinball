	...
	public static void main(String[] args) throws Exception {
		...
		parser.parse(
			...
			Arrays.asList(
				...
				new IDLInterface("IGroupActor", "FlexDMDGroupActor", "Object"),
				new IDLInterface("IFrameActor", "FlexDMDFrameActor", "Object"),
				new IDLInterface("ICompositeAction", "FlexDMDCompositeAction", "Object"),
				new IDLInterface("ITweenAction", "FlexDMDTweenAction", "Object"),
				new IDLInterface("IActionFactory", "FlexDMDActionFactory", "Object"),
				new IDLInterface("IActor", "FlexDMDActor", "Object"),
				new IDLInterface("IImageActor", "FlexDMDImageActor", "Object"),
				new IDLInterface("IVideoActor", "FlexDMDVideoActor", "Object"),
				new IDLInterface("ILabelActor", "FlexDMDLabelActor", "Object")));
