...
WebServer::WebServer() 
{
   ...
   m_addr = (string)LoadValueWithDefault(regKey[RegName::Standalone], "WebServerAddr"s, "0.0.0.0"s);
   m_port = (int)LoadValueWithDefault(regKey[RegName::Standalone], "WebServerPort"s, 2112);
}
...
void WebServer::Start()
{
   ...
   const bool debug = LoadValueWithDefault(regKey[RegName::Standalone], "WebServerDebug", false);
