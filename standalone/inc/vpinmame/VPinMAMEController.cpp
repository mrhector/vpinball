...
STDMETHODIMP VPinMAMEController::get_Lamp(int nLamp, VARIANT_BOOL *pVal) { return E_NOTIMPL; }
STDMETHODIMP VPinMAMEController::get_Solenoid(int nSolenoid, VARIANT_BOOL *pVal) { return E_NOTIMPL; }
...
STDMETHODIMP VPinMAMEController::get_Dip(int nNo, int *pVal) { return E_NOTIMPL; }
STDMETHODIMP VPinMAMEController::put_Dip(int nNo, int newVal) { return E_NOTIMPL; }
...
STDMETHODIMP VPinMAMEController::put_SolMask(int nLow, long newVal)
{
   ...
   if (nLow == 2)
      ...
      if (nLow == 0)
         ...
         mask = (mask & 0xFFFFFFFF) | (newVal << 32);
