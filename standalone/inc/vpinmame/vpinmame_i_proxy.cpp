...
name_disp_id_t VPinMAMERom::m_nameIDMap[] = {
		{ NULL },
		{ L"Audit", 4 },
		{ L"Checksum", 7 },
		{ L"ExpChecksum", 8 },
	...
	switch(dispIdMember) {
		...
		case 2: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				hr = get_State((long*)&V_I4(pVarResult));
			}
			break;
		}
		case 3: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_BSTR;
				hr = get_StateDescription(&V_BSTR(pVarResult));
			}
			break;
		}
		case 4: {
		...
		case 5: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_I4;
				hr = get_Length((long*)&V_I4(pVarResult));
			}
			break;
		}
		case 6: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_I4;
				hr = get_ExpLength((long*)&V_I4(pVarResult));
			}
			break;
		}
		case 7: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_I4;
				hr = get_Checksum((long*)&V_I4(pVarResult));
			}
			break;
		}
		case 8: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_I4;
				hr = get_ExpChecksum((long*)&V_I4(pVarResult));
			}
			break;
		}
		case 9: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_I4;
				hr = get_Flags((long*)&V_I4(pVarResult));
			}
			break;
		}
		default:
...
name_disp_id_t VPinMAMERoms::m_nameIDMap[] = {
		{ NULL },
		{ L"Audit", 4 },
		{ L"Available", 1 },
		{ L"Count", 8000 },
	...
	switch(dispIdMember) {
		...
		case DISPID_VALUE: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_DISPATCH;
				hr = get_Item(&var0, (IRom**)&V_DISPATCH(pVarResult));
				VariantClear(&var0);
			}
			break;
		}
		...
		case 1: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				hr = get_Available(&V_BOOL(pVarResult));
			}
			break;
		}
		case 2: {
...
name_disp_id_t VPinMAMEGameSettings::m_nameIDMap[] = {
		{ NULL },
		{ L"Clear", 2 },
	...
	switch(dispIdMember) {
		case 1: {
			if (wFlags & DISPATCH_METHOD) {
				...
				hr = ShowSettingsDlg((LONG_PTR)V_UI4(&var0));
				VariantClear(&var0);
			}
			break;
		}
		...
		case 3: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				hr = get_Value(V_BSTR(&var0), pVarResult);
				VariantClear(&var0);
			}
		...
		case 4: {
			if (wFlags & DISPATCH_METHOD) {
				...
				hr = SetDisplayPosition(var0, var1, (LONG_PTR)V_UI4(&var2));
				VariantClear(&var0);
				VariantClear(&var1);
				VariantClear(&var2);
			}
...
name_disp_id_t VPinMAMEGame::m_nameIDMap[] = {
		{ NULL },
		{ L"CloneOf", 5 },
		{ L"Description", 2 },
		{ L"IsSupported", 9 },
	...
	switch(dispIdMember) {
		...
		case 2: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_BSTR;
				hr = get_Description(&V_BSTR(pVarResult));
			}
			break;
		}
		case 3: {
		...
		case 4: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_BSTR;
				hr = get_Manufacturer(&V_BSTR(pVarResult));
			}
			break;
		}
		case 5: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_BSTR;
				hr = get_CloneOf(&V_BSTR(pVarResult));
			}
			break;
		}
		case 6: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_DISPATCH;
				hr = get_Roms((IRoms**)&V_DISPATCH(pVarResult));
			}
			break;
		}
		case 7: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_DISPATCH;
				hr = get_Settings((IGameSettings**)&V_DISPATCH(pVarResult));
			}
			break;
		}
		case 8: {
			if (wFlags & DISPATCH_METHOD) {
				...
				V_VT(pVarResult) = VT_I4;
				hr = ShowInfoDlg(V_I4(&var0), (LONG_PTR)V_UI4(&var1), (int*)&V_I4(pVarResult));
				VariantClear(&var0);
				VariantClear(&var1);
			}
			break;
		...
		case 9: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_BOOL;
				hr = get_IsSupported(&V_BOOL(pVarResult));
			}
			break;
		}
		default:
...
name_disp_id_t VPinMAMEGames::m_nameIDMap[] = {
		{ NULL },
		{ L"Count", 8001 }
};
	...
	switch(dispIdMember) {
		...
		case DISPID_VALUE: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				VariantCopyInd(&var0, &pDispParams->rgvarg[--index]);
				V_VT(pVarResult) = VT_DISPATCH;
				hr = get_Item(&var0, (IGame**)&V_DISPATCH(pVarResult));
				VariantClear(&var0);
			}
			break;
		}
...
name_disp_id_t VPinMAMEControllerSettings::m_nameIDMap[] = {
		{ NULL },
		{ L"Clear", 2 },
		{ L"InstallDir", 4 },
		{ L"ShowSettingsDlg", 1 },
	...
	switch(dispIdMember) {
		...
		case 4: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_BSTR;
				hr = get_InstallDir(&V_BSTR(pVarResult));
			}
			break;
		}
		default:
...
name_disp_id_t VPinMAMEController::m_nameIDMap[] = {
		{ NULL },
	...
	switch(dispIdMember) {
		case 1: {
			if (wFlags & DISPATCH_METHOD) {
				...
				hr = Run((LONG_PTR)V_UI4(&var0), V_I4(&var1));
				VariantClear(&var0);
				VariantClear(&var1);
			}
			break;
		...
		case 3: {
			if (wFlags & DISPATCH_METHOD) {
				...
				V_UI4(&var0) = 0;
				VariantChangeType(&var0, (index > 0) ? &pDispParams->rgvarg[--index] : &var0, 0, VT_UI4);
				hr = ShowOptsDialog((LONG_PTR)V_UI4(&var0));
				VariantClear(&var0);
			}
			break;
		}
		case 4: {
			if (wFlags & DISPATCH_METHOD) {
				...
				V_UI4(&var0) = 0;
				VariantChangeType(&var0, (index > 0) ? &pDispParams->rgvarg[--index] : &var0, 0, VT_UI4);
				hr = ShowAboutDialog((LONG_PTR)V_UI4(&var0));
				VariantClear(&var0);
			}
			break;
		}
		case 5: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_BOOL;
				hr = get_Lamp(V_I4(&var0), &V_BOOL(pVarResult));
				VariantClear(&var0);
			}
			break;
		}
		case 6: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				VariantChangeType(&var0, &pDispParams->rgvarg[--index], 0, VT_I4);
				V_VT(pVarResult) = VT_BOOL;
				hr = get_Solenoid(V_I4(&var0), &V_BOOL(pVarResult));
				VariantClear(&var0);
			}
			break;
		}
		case 7: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				VariantChangeType(&var0, &pDispParams->rgvarg[--index], 0, VT_I4);
				V_VT(pVarResult) = VT_BOOL;
				hr = get_Switch(V_I4(&var0), &V_BOOL(pVarResult));
				VariantClear(&var0);
			}
			else if (wFlags & DISPATCH_PROPERTYPUT) {
				...
				hr = put_Switch(V_I4(&var0), V_BOOL(&var1));
				VariantClear(&var0);
				VariantClear(&var1);
			}
			break;
		...
		case 12: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_BOOL;
				hr = get_WPCNumbering(&V_BOOL(pVarResult));
			}
			break;
		}
		case 13: {
		...
		case 14: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				hr = get_ChangedLamps(pVarResult);
			}
			break;
		}
		case 15: {
		...
		case 16: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				hr = get_ChangedSolenoids(pVarResult);
			}
			break;
		}
		case 17: {
		...
		case 19: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_BOOL;
				hr = get_HandleKeyboard(&V_BOOL(pVarResult));
			}
			else if (wFlags & DISPATCH_PROPERTYPUT) {
				...
				hr = put_HandleKeyboard(V_BOOL(&var0));
				VariantClear(&var0);
			}
			break;
		}
		case 21: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_BOOL;
				hr = get_ShowTitle(&V_BOOL(pVarResult));
			}
			else if (wFlags & DISPATCH_PROPERTYPUT) {
		...
		case 22: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_BOOL;
				hr = get_Pause(&V_BOOL(pVarResult));
			}
			else if (wFlags & DISPATCH_PROPERTYPUT) {
		...
		case 23: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				hr = get_Machines(V_BSTR(&var0), pVarResult);
				VariantClear(&var0);
			}
			break;
		}
		case 24: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_BOOL;
				hr = get_Running(&V_BOOL(pVarResult));
			}
			break;
		}
		case 25: {
			if (wFlags & DISPATCH_METHOD) {
				...
				VariantChangeType(&var1, (index > 0) ? &pDispParams->rgvarg[--index] : &var1, 0, VT_UI4);
				V_VT(pVarResult) = VT_BOOL;
				hr = CheckROMS(V_I4(&var0), (LONG_PTR)V_UI4(&var1), &V_BOOL(pVarResult));
				VariantClear(&var0);
				VariantClear(&var1);
			}
			break;
		...
		case 26: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_I4;
				hr = get_HandleMechanics((int*)&V_I4(pVarResult));
			}
			else if (wFlags & DISPATCH_PROPERTYPUT) {
				...
				V_VT(&var0) = VT_EMPTY;
				VariantChangeType(&var0, &pDispParams->rgvarg[--index], 0, VT_I4);
				hr = put_HandleMechanics(V_I4(&var0));
				VariantClear(&var0);
			}
			break;
		}
		case 27: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				VariantChangeType(&var0, &pDispParams->rgvarg[--index], 0, VT_I4);
				V_VT(pVarResult) = VT_I4;
				hr = get_GIString(V_I4(&var0), (int*)&V_I4(pVarResult));
				VariantClear(&var0);
			}
			break;
		}
		case 28: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				hr = get_ChangedGIStrings(pVarResult);
			}
			break;
		}
		case 29: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_BOOL;
				hr = get_ShowDMDOnly(&V_BOOL(pVarResult));
			}
			else if (wFlags & DISPATCH_PROPERTYPUT) {
				...
				V_VT(&var0) = VT_EMPTY;
				VariantChangeType(&var0, &pDispParams->rgvarg[--index], 0, VT_BOOL);
				hr = put_ShowDMDOnly(V_BOOL(&var0));
				VariantClear(&var0);
			}
			break;
		}
		case 30: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_BSTR;
				hr = get_SplashInfoLine(&V_BSTR(pVarResult));
			}
			else if (wFlags & DISPATCH_PROPERTYPUT) {
				...
				V_VT(&var0) = VT_EMPTY;
				VariantChangeType(&var0, &pDispParams->rgvarg[--index], 0, VT_BSTR);
				hr = put_SplashInfoLine(V_BSTR(&var0));
				VariantClear(&var0);
			}
			break;
		}
		...
		case 32: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				VariantChangeType(&var0, &pDispParams->rgvarg[--index], 0, VT_I4);
				V_VT(pVarResult) = VT_I4;
				hr = get_Dip(V_I4(&var0), (int*)&V_I4(pVarResult));
				VariantClear(&var0);
			}
			else if (wFlags & DISPATCH_PROPERTYPUT) {
				...
				hr = put_Dip(V_I4(&var0), V_I4(&var1));
				VariantClear(&var0);
				VariantClear(&var1);
			}
			break;
		...
		case 34: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				VariantChangeType(&var0, &pDispParams->rgvarg[--index], 0, VT_I4);
				V_VT(pVarResult) = VT_I4;
				hr = get_GetMech(V_I4(&var0), (int*)&V_I4(pVarResult));
				VariantClear(&var0);
			}
			break;
		}
		case 35: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_BOOL;
				hr = get_ShowFrame(&V_BOOL(pVarResult));
			}
			else if (wFlags & DISPATCH_PROPERTYPUT) {
		...
		case 41: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_BOOL;
				hr = get_DoubleSize(&V_BOOL(pVarResult));
			}
			else if (wFlags & DISPATCH_PROPERTYPUT) {
		...
		case 42: {
			if (wFlags & DISPATCH_METHOD) {
				...
				V_UI4(&var2) = 0;
				VariantChangeType(&var2, (index > 0) ? &pDispParams->rgvarg[--index] : &var2, 0, VT_UI4);
				hr = SetDisplayPosition(V_I4(&var0), V_I4(&var1), (LONG_PTR)V_UI4(&var2));
				VariantClear(&var0);
				VariantClear(&var1);
				VariantClear(&var2);
			}
		...
		case 43: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_BOOL;
				hr = get_LockDisplay(&V_BOOL(pVarResult));
			}
			else if (wFlags & DISPATCH_PROPERTYPUT) {
				...
				V_VT(&var0) = VT_EMPTY;
				VariantChangeType(&var0, &pDispParams->rgvarg[--index], 0, VT_BOOL);
				hr = put_LockDisplay(V_BOOL(&var0));
				VariantClear(&var0);
			}
			break;
		}
		case 45: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				VariantChangeType(&var0, &pDispParams->rgvarg[--index], 0, VT_I4);
				V_VT(pVarResult) = VT_I4;
				hr = get_SolMask(V_I4(&var0), (long*)&V_I4(pVarResult));
				VariantClear(&var0);
			}
			else if (wFlags & DISPATCH_PROPERTYPUT) {
				...
				V_VT(&var1) = VT_EMPTY;
				VariantChangeType(&var1, &pDispParams->rgvarg[--index], 0, VT_I4);
				hr = put_SolMask(V_I4(&var0), V_I4(&var1));
				VariantClear(&var0);
				VariantClear(&var1);
			}
			break;
		...
		case 46: {
			if (wFlags & DISPATCH_METHOD) {
				...
				V_UI4(&var0) = 0;
				VariantChangeType(&var0, (index > 0) ? &pDispParams->rgvarg[--index] : &var0, 0, VT_UI4);
				hr = ShowPathesDialog((LONG_PTR)V_UI4(&var0));
				VariantClear(&var0);
			}
			break;
		}
		case 48: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_BSTR;
				hr = get_Version(&V_BSTR(pVarResult));
			}
			break;
		}
		case 49: {
			if (wFlags & DISPATCH_PROPERTYPUT) {
				...
				V_VT(&var1) = VT_EMPTY;
				VariantChangeType(&var1, &pDispParams->rgvarg[--index], 0, VT_I4);
				hr = put_Mech(V_I4(&var0), V_I4(&var1));
				VariantClear(&var0);
				VariantClear(&var1);
			}
			break;
		...
		case 50: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				hr = get_NewSoundCommands(pVarResult);
			}
			break;
		}
		case 51: {
			if (wFlags & DISPATCH_METHOD) {
				hr = m_pGames->Invoke(DISPID_VALUE, IID_IGames, lcid, DISPATCH_PROPERTYGET, pDispParams, pVarResult, pExcepInfo, puArgErr);
			}
				...
				V_VT(pVarResult) = VT_DISPATCH;
				hr = get_Games((IGames**)&V_DISPATCH(pVarResult));
			}
			break;
		}
		case 52: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_DISPATCH;
				hr = get_Settings((IControllerSettings**)&V_DISPATCH(pVarResult));
			}
			break;
		}
		case 53: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				hr = get_ChangedLEDs(V_I4(&var0), V_I4(&var1), V_I4(&var2), V_I4(&var3), pVarResult);
				VariantClear(&var0);
				VariantClear(&var1);
				VariantClear(&var2);
				VariantClear(&var3);
		...
		case 54: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_BOOL;
				hr = get_Hidden(&V_BOOL(pVarResult));
			}
			else if (wFlags & DISPATCH_PROPERTYPUT) {
		...
		case 55: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_DISPATCH;
				hr = get_Game((IGame**)&V_DISPATCH(pVarResult));
			}
			break;
		}
		case 56: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_BOOL;
				hr = get_MechSamples(&V_BOOL(pVarResult));
			}
			else if (wFlags & DISPATCH_PROPERTYPUT) {
				...
				V_VT(&var0) = VT_EMPTY;
				VariantChangeType(&var0, &pDispParams->rgvarg[--index], 0, VT_BOOL);
				hr = put_MechSamples(V_BOOL(&var0));
				VariantClear(&var0);
			}
			break;
		}
		case 57: {
			if (wFlags & DISPATCH_METHOD) {
				...
				V_UI4(&var0) = 0;
				VariantChangeType(&var0, (index > 0) ? &pDispParams->rgvarg[--index] : &var0, 0, VT_UI4);
				hr = GetWindowRect((LONG_PTR)V_UI4(&var0), pVarResult);
				VariantClear(&var0);
			}
			break;
		}
		case 58: {
			if (wFlags & DISPATCH_METHOD) {
				...
				V_UI4(&var0) = 0;
				VariantChangeType(&var0, (index > 0) ? &pDispParams->rgvarg[--index] : &var0, 0, VT_UI4);
				hr = GetClientRect((LONG_PTR)V_UI4(&var0), pVarResult);
				VariantClear(&var0);
			}
			break;
		}
		case 78: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_I4;
				hr = get_RawDmdWidth((int*)&V_I4(pVarResult));
			}
			break;
		}
		case 79: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_I4;
				hr = get_RawDmdHeight((int*)&V_I4(pVarResult));
			}
			break;
		}
		case 80: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				hr = get_RawDmdPixels(pVarResult);
			}
			break;
		}
		case 59: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_I4;
				hr = get_DmdWidth((int*)&V_I4(pVarResult));
			}
			break;
		}
		case 60: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_I4;
				hr = get_DmdHeight((int*)&V_I4(pVarResult));
			}
			break;
		}
		case 61: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				VariantChangeType(&var1, &pDispParams->rgvarg[--index], 0, VT_I4);
				V_VT(pVarResult) = VT_I4;
				hr = get_DmdPixel(V_I4(&var0), V_I4(&var1), (int*)&V_I4(pVarResult));
				VariantClear(&var0);
				VariantClear(&var1);
			}
			break;
		...
		case 62: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_I4;
				hr = get_updateDmdPixels((int**)V_INT_PTR(&var0), V_I4(&var1), V_I4(&var2), (int*)&V_I4(pVarResult));
				VariantClear(&var0);
				VariantClear(&var1);
				VariantClear(&var2);
			}
		...
		case 63: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				VariantChangeType(&var0, &pDispParams->rgvarg[--index], 0, VT_INT_PTR);
				V_VT(pVarResult) = VT_I4;
				hr = get_ChangedLampsState((int**)V_INT_PTR(&var0), (int*)&V_I4(pVarResult));
				VariantClear(&var0);
			}
			break;
		}
		case 64: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				VariantChangeType(&var0, &pDispParams->rgvarg[--index], 0, VT_INT_PTR);
				V_VT(pVarResult) = VT_I4;
				hr = get_LampsState((int**)V_INT_PTR(&var0), (int*)&V_I4(pVarResult));
				VariantClear(&var0);
			}
			break;
		}
		case 65: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				VariantChangeType(&var0, &pDispParams->rgvarg[--index], 0, VT_INT_PTR);
				V_VT(pVarResult) = VT_I4;
				hr = get_ChangedSolenoidsState((int**)V_INT_PTR(&var0), (int*)&V_I4(pVarResult));
				VariantClear(&var0);
			}
			break;
		}
		case 66: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				VariantChangeType(&var0, &pDispParams->rgvarg[--index], 0, VT_INT_PTR);
				V_VT(pVarResult) = VT_I4;
				hr = get_SolenoidsState((int**)V_INT_PTR(&var0), (int*)&V_I4(pVarResult));
				VariantClear(&var0);
			}
			break;
		}
		case 67: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				VariantChangeType(&var0, &pDispParams->rgvarg[--index], 0, VT_INT_PTR);
				V_VT(pVarResult) = VT_I4;
				hr = get_ChangedGIsState((int**)V_INT_PTR(&var0), (int*)&V_I4(pVarResult));
				VariantClear(&var0);
			}
			break;
		}
		case 68: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_I4;
				hr = get_MasterVolume((int*)&V_I4(pVarResult));
			}
			else if (wFlags & DISPATCH_PROPERTYPUT) {
		...
		case 69: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_I4;
				hr = get_EnumAudioDevices((int*)&V_I4(pVarResult));
			}
			break;
		}
		case 70: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_I4;
				hr = get_AudioDevicesCount((int*)&V_I4(pVarResult));
			}
			break;
		}
		case 71: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				VariantChangeType(&var0, &pDispParams->rgvarg[--index], 0, VT_I4);
				V_VT(pVarResult) = VT_BSTR;
				hr = get_AudioDeviceDescription(V_I4(&var0), &V_BSTR(pVarResult));
				VariantClear(&var0);
			}
			break;
		}
		case 72: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				VariantChangeType(&var0, &pDispParams->rgvarg[--index], 0, VT_I4);
				V_VT(pVarResult) = VT_BSTR;
				hr = get_AudioDeviceModule(V_I4(&var0), &V_BSTR(pVarResult));
				VariantClear(&var0);
			}
			break;
		}
		case 73: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_I4;
				hr = get_CurrentAudioDevice((int*)&V_I4(pVarResult));
			}
			else if (wFlags & DISPATCH_PROPERTYPUT) {
				...
				V_VT(&var0) = VT_EMPTY;
				VariantChangeType(&var0, &pDispParams->rgvarg[--index], 0, VT_I4);
				hr = put_CurrentAudioDevice(V_I4(&var0));
				VariantClear(&var0);
			}
			break;
		}
		case 74: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_I4;
				hr = get_FastFrames((int*)&V_I4(pVarResult));
			}
			else if (wFlags & DISPATCH_PROPERTYPUT) {
		...
		case 75: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_BOOL;
				hr = get_IgnoreRomCrc(&V_BOOL(pVarResult));
			}
			else if (wFlags & DISPATCH_PROPERTYPUT) {
				...
				V_VT(&var0) = VT_EMPTY;
				VariantChangeType(&var0, &pDispParams->rgvarg[--index], 0, VT_BOOL);
				hr = put_IgnoreRomCrc(V_BOOL(&var0));
				VariantClear(&var0);
			}
			break;
		}
		case 76: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_BOOL;
				hr = get_CabinetMode(&V_BOOL(pVarResult));
			}
			else if (wFlags & DISPATCH_PROPERTYPUT) {
				...
				V_VT(&var0) = VT_EMPTY;
				VariantChangeType(&var0, &pDispParams->rgvarg[--index], 0, VT_BOOL);
				hr = put_CabinetMode(V_BOOL(&var0));
				VariantClear(&var0);
			}
			break;
		}
		case 77: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_BOOL;
				hr = get_ShowPinDMD(&V_BOOL(pVarResult));
			}
			else if (wFlags & DISPATCH_PROPERTYPUT) {
		...
		case 81: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_BOOL;
				hr = get_ShowWinDMD(&V_BOOL(pVarResult));
			}
			else if (wFlags & DISPATCH_PROPERTYPUT) {
		...
		case 82: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_I4;
				hr = get_ChangedLEDsState(V_I4(&var0), V_I4(&var1), V_I4(&var2), V_I4(&var3), (int**)V_INT_PTR(&var4), (int*)&V_I4(pVarResult));
				VariantClear(&var0);
				VariantClear(&var1);
				VariantClear(&var2);
				VariantClear(&var3);
		...
		case 83: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				hr = get_RawDmdColoredPixels(pVarResult);
			}
			break;
		}
		case 84: {
		...
		case 85: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				hr = get_ChangedNVRAM(pVarResult);
			}
			break;
		}
		case 86: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_I4;
				hr = get_SoundMode((int*)&V_I4(pVarResult));
			}
			else if (wFlags & DISPATCH_PROPERTYPUT) {
		...
		case 87: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_BSTR;
				hr = get_ROMName(&V_BSTR(pVarResult));
			}
			break;
		}
		default:
