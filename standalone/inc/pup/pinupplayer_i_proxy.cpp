...
name_disp_id_t PinUpPlayerPinDisplay::m_nameIDMap[] = {
		{ NULL },
	...
	switch(dispIdMember) {
		...
		case 0x000000ca: {
			if (wFlags & DISPATCH_METHOD) {
				...
				hr = playlistadd(V_I4(&var0), V_BSTR(&var1), V_I4(&var2), V_I4(&var3));
				VariantClear(&var0);
				VariantClear(&var1);
				VariantClear(&var2);
				VariantClear(&var3);
		...
		case 0x000000cb: {
			if (wFlags & DISPATCH_METHOD) {
				...
				V_VT(&var1) = VT_EMPTY;
				VariantChangeType(&var1, &pDispParams->rgvarg[--index], 0, VT_BSTR);
				hr = playlistplay(V_I4(&var0), V_BSTR(&var1));
				VariantClear(&var0);
				VariantClear(&var1);
			}
			break;
		...
		case 0x000000cc: {
			if (wFlags & DISPATCH_METHOD) {
				...
				hr = playlistplayex(V_I4(&var0), V_BSTR(&var1), V_BSTR(&var2), V_I4(&var3), V_I4(&var4));
				VariantClear(&var0);
				VariantClear(&var1);
				VariantClear(&var2);
				VariantClear(&var3);
		...
		case 0x000000cd: {
			if (wFlags & DISPATCH_METHOD) {
				...
				V_VT(&var2) = VT_EMPTY;
				VariantChangeType(&var2, &pDispParams->rgvarg[--index], 0, VT_BSTR);
				hr = play(V_I4(&var0), V_BSTR(&var1), V_BSTR(&var2));
				VariantClear(&var0);
				VariantClear(&var1);
				VariantClear(&var2);
			}
		...
		case 0x000000ce: {
			if (wFlags & DISPATCH_METHOD) {
				...
				hr = setWidth(V_I4(&var0), V_I4(&var1));
				VariantClear(&var0);
				VariantClear(&var1);
			}
			break;
		...
		case 0x000000cf: {
			if (wFlags & DISPATCH_METHOD) {
				...
				V_VT(&var1) = VT_EMPTY;
				VariantChangeType(&var1, &pDispParams->rgvarg[--index], 0, VT_I4);
				hr = setHeight(V_I4(&var0), V_I4(&var1));
				VariantClear(&var0);
				VariantClear(&var1);
			}
			break;
		...
		case 0x000000d0: {
			if (wFlags & DISPATCH_METHOD) {
				...
				V_VT(&var1) = VT_EMPTY;
				VariantChangeType(&var1, &pDispParams->rgvarg[--index], 0, VT_I4);
				hr = setPosX(V_I4(&var0), V_I4(&var1));
				VariantClear(&var0);
				VariantClear(&var1);
			}
			break;
		...
		case 0x000000d1: {
			if (wFlags & DISPATCH_METHOD) {
				...
				V_VT(&var1) = VT_EMPTY;
				VariantChangeType(&var1, &pDispParams->rgvarg[--index], 0, VT_I4);
				hr = setPosY(V_I4(&var0), V_I4(&var1));
				VariantClear(&var0);
				VariantClear(&var1);
			}
			break;
		...
		case 0x000000d2: {
			if (wFlags & DISPATCH_METHOD) {
				...
				V_VT(&var2) = VT_EMPTY;
				VariantChangeType(&var2, &pDispParams->rgvarg[--index], 0, VT_I4);
				hr = setAspect(V_I4(&var0), V_I4(&var1), V_I4(&var2));
				VariantClear(&var0);
				VariantClear(&var1);
				VariantClear(&var2);
			}
		...
		case 0x000000d3: {
			if (wFlags & DISPATCH_METHOD) {
				...
				V_VT(&var1) = VT_EMPTY;
				VariantChangeType(&var1, &pDispParams->rgvarg[--index], 0, VT_I4);
				hr = setVolume(V_I4(&var0), V_I4(&var1));
				VariantClear(&var0);
				VariantClear(&var1);
			}
			break;
		...
		case 0x000000d7: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				hr = get_isPlaying(V_I4(&var0), (long*)&V_I4(pVarResult));
				VariantClear(&var0);
			}
				...
				V_VT(&var1) = VT_EMPTY;
				VariantChangeType(&var1, &pDispParams->rgvarg[--index], 0, VT_I4);
				hr = put_isPlaying(V_I4(&var0), V_I4(&var1));
				VariantClear(&var0);
				VariantClear(&var1);
			}
			break;
		...
		case 0x000000d9: {
			if (wFlags & DISPATCH_METHOD) {
				...
				V_VT(&var1) = VT_EMPTY;
				VariantChangeType(&var1, &pDispParams->rgvarg[--index], 0, VT_I4);
				hr = SetLength(V_I4(&var0), V_I4(&var1));
				VariantClear(&var0);
				VariantClear(&var1);
			}
			break;
		...
		case 0x000000da: {
			if (wFlags & DISPATCH_METHOD) {
				...
				V_VT(&var1) = VT_EMPTY;
				VariantChangeType(&var1, &pDispParams->rgvarg[--index], 0, VT_I4);
				hr = SetLoop(V_I4(&var0), V_I4(&var1));
				VariantClear(&var0);
				VariantClear(&var1);
			}
			break;
		...
		case 0x000000db: {
			if (wFlags & DISPATCH_METHOD) {
				...
				V_VT(&var1) = VT_EMPTY;
				VariantChangeType(&var1, &pDispParams->rgvarg[--index], 0, VT_I4);
				hr = SetBackGround(V_I4(&var0), V_I4(&var1));
				VariantClear(&var0);
				VariantClear(&var1);
			}
			break;
		...
		case 0x000000dc: {
			if (wFlags & DISPATCH_METHOD) {
				...
				V_VT(&var1) = VT_EMPTY;
				VariantChangeType(&var1, &pDispParams->rgvarg[--index], 0, VT_I4);
				hr = BlockPlay(V_I4(&var0), V_I4(&var1));
				VariantClear(&var0);
				VariantClear(&var1);
			}
			break;
		...
		case 0x000000de: {
			if (wFlags & DISPATCH_METHOD) {
				...
				hr = SetScreenEx(V_I4(&var0), V_I4(&var1), V_I4(&var2), V_I4(&var3), V_I4(&var4), V_I4(&var5));
				VariantClear(&var0);
				VariantClear(&var1);
				VariantClear(&var2);
				VariantClear(&var3);
		...
		case 0x000000df: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_I4;
				hr = get_SN((long*)&V_I4(pVarResult));
			}
			else if (wFlags & DISPATCH_PROPERTYPUT) {
		...
		case 0x000000e0: {
			if (wFlags & DISPATCH_METHOD) {
				...
				V_VT(&var1) = VT_EMPTY;
				VariantChangeType(&var1, &pDispParams->rgvarg[--index], 0, VT_I4);
				hr = B2SData(V_BSTR(&var0), V_I4(&var1));
				VariantClear(&var0);
				VariantClear(&var1);
			}
			break;
		...
		case 0x000000e1: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				hr = get_B2SFilter(&V_BSTR(pVarResult));
			}
			else if (wFlags & DISPATCH_PROPERTYPUT) {
		...
		case 0x000000e4: {
			if (wFlags & DISPATCH_METHOD) {
				...
				V_VT(&var1) = VT_EMPTY;
				VariantChangeType(&var1, &pDispParams->rgvarg[--index], 0, VT_BSTR);
				hr = B2SInit(V_BSTR(&var0), V_BSTR(&var1));
				VariantClear(&var0);
				VariantClear(&var1);
			}
			break;
		...
		case 0x000000e6: {
			if (wFlags & DISPATCH_METHOD) {
				...
				hr = LabelNew(V_I4(&var0), V_BSTR(&var1), V_BSTR(&var2), V_I4(&var3), V_I4(&var4), V_I4(&var5), V_I4(&var6), V_I4(&var7), V_I4(&var8), V_I4(&var9), V_I4(&var10), V_I4(&var11));
				VariantClear(&var0);
				VariantClear(&var1);
				VariantClear(&var2);
				VariantClear(&var3);
		...
		case 0x000000e7: {
			if (wFlags & DISPATCH_METHOD) {
				...
				hr = LabelSet(V_I4(&var0), V_BSTR(&var1), V_BSTR(&var2), V_I4(&var3), V_BSTR(&var4));
				VariantClear(&var0);
				VariantClear(&var1);
				VariantClear(&var2);
				VariantClear(&var3);
		...
		case 0x000000e9: {
			if (wFlags & DISPATCH_METHOD) {
				...
				hr = LabelShowPage(V_I4(&var0), V_I4(&var1), V_I4(&var2), V_BSTR(&var3));
				VariantClear(&var0);
				VariantClear(&var1);
				VariantClear(&var2);
				VariantClear(&var3);
		...
		case 0x000000eb: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_BSTR;
				hr = get_GetGame(&V_BSTR(pVarResult));
			}
			else if (wFlags & DISPATCH_PROPERTYPUT) {
		...
		case 0x000000ec: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_BSTR;
				hr = get_GetRoot(&V_BSTR(pVarResult));
			}
			else if (wFlags & DISPATCH_PROPERTYPUT) {
		...
		case 0x000000ed: {
			if (wFlags & DISPATCH_METHOD) {
				...
				hr = SoundAdd(V_BSTR(&var0), V_BSTR(&var1), V_I4(&var2), V_R8(&var3), V_R8(&var4), V_BSTR(&var5));
				VariantClear(&var0);
				VariantClear(&var1);
				VariantClear(&var2);
				VariantClear(&var3);
		...
		case 0x000000ef: {
			if (wFlags & DISPATCH_METHOD) {
				...
				V_VT(&var5) = VT_EMPTY;
				VariantChangeType(&var5, &pDispParams->rgvarg[--index], 0, VT_BSTR);
				hr = PuPSound(V_BSTR(&var0), V_I4(&var1), V_I4(&var2), V_I4(&var3), V_I4(&var4), V_BSTR(&var5));
				VariantClear(&var0);
				VariantClear(&var1);
				VariantClear(&var2);
				VariantClear(&var3);
		...
		case 0x000000f1: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_BSTR;
				hr = get_B2SDisplays(&V_BSTR(pVarResult));
			}
			break;
		}
		case 0x000000f2: {
			if (wFlags & DISPATCH_METHOD) {
				...
				V_VT(&var1) = VT_EMPTY;
				VariantChangeType(&var1, &pDispParams->rgvarg[--index], 0, VT_I4);
				hr = setVolumeCurrent(V_I4(&var0), V_I4(&var1));
				VariantClear(&var0);
				VariantClear(&var1);
			}
			break;
		...
		case 0x000000f3: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				VariantChangeType(&var3, &pDispParams->rgvarg[--index], 0, VT_BSTR);
				V_VT(pVarResult) = VT_I4;
				hr = get_GameUpdate(V_BSTR(&var0), V_I4(&var1), V_I4(&var2), V_BSTR(&var3), (long*)&V_I4(pVarResult));
				VariantClear(&var0);
				VariantClear(&var1);
				VariantClear(&var2);
				VariantClear(&var3);
