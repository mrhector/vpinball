...
FormBackglass::FormBackglass()
{
   ...
   m_pStartupTimer = new B2S::Timer(2000, std::bind(&FormBackglass::StartupTimerTick, this, std::placeholders::_1));
   m_pStartupTimer->Start();

   // create rotation timer
   m_pRotateTimer = new B2S::Timer(m_rotateTimerInterval, std::bind(&FormBackglass::RotateTimerTick, this, std::placeholders::_1));
}
...
void FormBackglass::OnPaint(B2S::Graphics* pGraphics)
{
...
void FormBackglass::DrawImage(B2S::Graphics* pGraphics, B2SPictureBox* pPicbox)
{
   if (pPicbox) {
...
void FormBackglass::StartupTimerTick(B2S::Timer* pTimer)
{
...
void FormBackglass::RotateTimerTick(B2S::Timer* pTimer)
{
