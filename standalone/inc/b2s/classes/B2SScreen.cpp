...
void B2SScreen::Show()
{
   ...
   g_pplayer->SetB2SBackglassRenderCallback(std::bind(&B2SScreen::RenderBackglass, this, std::placeholders::_1));
   ...
   if (m_dmdToBeShown) {
      ...
      g_pplayer->SetB2SDMDRenderCallback(std::bind(&B2SScreen::RenderDMD, this, std::placeholders::_1));
   }
}
...
{
   if (m_frameSkip != 0) {
      m_backglassFrameSkip++;
      if (m_backglassFrameSkip <= m_frameSkip)
         return;
      m_backglassFrameSkip = 0;
   }
