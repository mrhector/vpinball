...
B2SReelDisplay::B2SReelDisplay()
{
   ...
   m_pTimerRR = new B2S::Timer(17, std::bind(&B2SReelDisplay::TimerRRTick, this, std::placeholders::_1));
   m_pTimerIA = new B2S::Timer(17, std::bind(&B2SReelDisplay::TimerIATick, this, std::placeholders::_1));
}
...
void B2SReelDisplay::TimerRRTick(B2S::Timer* pTimer)
{
...
void B2SReelDisplay::TimerIATick(B2S::Timer* pTimer)
{
   if (!IsInAction()) {
      m_pTimerIA->Stop();
