...
void Segment::Draw(B2S::Graphics* pGraphics)
{
...
void Segment::DrawLight(B2S::Graphics* pGraphics)
{
   if (!m_on) {
      SetTransform(pGraphics);
      GetLightData();
...
void Segment::PaintSegment(B2S::Graphics* pGraphics, GraphicsPath* pPath)
{
...
void Segment::SetTransform(B2S::Graphics* pGraphics)
{
   B2S::Matrix* pMatrix;
   if (!m_pExternMatrix)
      pMatrix = new B2S::Matrix();
   else
...
void Segment::Transform(B2S::Matrix* pMatrix)
{
