...
void SegmentNumber::Init(const SDL_FPoint& location, SegmentNumberType type, B2S::Matrix* pMatrix, float thickness)
{
...
void SegmentNumber::Draw(B2S::Graphics* pGraphics)
{
...
void SegmentNumber::InitMatrix(const SDL_FPoint& location, B2S::Matrix* pMatrix)
{
