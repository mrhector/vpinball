...
B2SReelBox::B2SReelBox() : B2SBaseBox()
{
   ...
   m_pTimer = new B2S::Timer((m_rollingInterval / (((m_intermediates == -1) ? 3 : m_intermediates) + 2)), std::bind(&B2SReelBox::ReelAnimationTimerTick, this, std::placeholders::_1));
}
...
void B2SReelBox::OnPaint(B2S::Graphics* pGraphics)
{
...
void B2SReelBox::ReelAnimationTimerTick(B2S::Timer* pTimer)
{
