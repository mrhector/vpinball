...
public:
   ...
   virtual void OnPaint(B2S::Graphics* pGraphics);
   ...
   virtual void SetBackgroundImage(SDL_Surface* pBackgroundImage) { m_pBackgroundImage = pBackgroundImage; Invalidate(); }
