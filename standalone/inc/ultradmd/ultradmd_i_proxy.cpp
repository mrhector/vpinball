...
STDMETHODIMP UltraDMDDMDObject::GetDocumentation(INT index, BSTR *pBstrName, BSTR *pBstrDocString, DWORD *pdwHelpContext, BSTR *pBstrHelpFile) {
	if (index == MEMBERID_NIL) {
		*pBstrName = SysAllocString(L"UltraDMDDMDObject");
		return S_OK;
	}
	return E_NOTIMPL;
}
