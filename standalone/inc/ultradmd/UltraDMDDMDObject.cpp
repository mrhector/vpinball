...
{
   return m_pUltraDMD->GetFlexDMD()->get_DmdColoredPixels(pRetVal);
}

STDMETHODIMP UltraDMDDMDObject::get_DmdPixels(VARIANT *pRetVal)
{
   return m_pUltraDMD->GetFlexDMD()->get_DmdPixels(pRetVal);
}

STDMETHODIMP UltraDMDDMDObject::get_Width(unsigned short *pRetVal)
{
   return m_pUltraDMD->GetFlexDMD()->get_Width(pRetVal);
}

STDMETHODIMP UltraDMDDMDObject::get_Height(unsigned short *pRetVal)
{
   return m_pUltraDMD->GetFlexDMD()->get_Height(pRetVal);
}
