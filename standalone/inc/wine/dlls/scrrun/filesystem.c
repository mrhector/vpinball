                ...
                UINT cNames, LCID lcid, DISPID *rgDispId)
{
	...
	*rgDispId = DISPID_UNKNOWN;
	...
	if (!wcsicmp(*rgszNames, L"Line")) {
		*rgDispId = 0x00002710;
	}
	else if (!wcsicmp(*rgszNames, L"Column")) {
		*rgDispId = 0xfffffdef;
	}
	else if (!wcsicmp(*rgszNames, L"AtEndOfStream")) {
		*rgDispId = 0x00002712;
	}
	else if (!wcsicmp(*rgszNames, L"AtEndOfLine")) {
		*rgDispId = 0x00002713;
	}
	else if (!wcsicmp(*rgszNames, L"Read")) {
		*rgDispId = 0x00002714;
	}
	else if (!wcsicmp(*rgszNames, L"ReadLine")) {
		*rgDispId = 0x00002715;
	}
	else if (!wcsicmp(*rgszNames, L"ReadAll")) {
		*rgDispId = 0x00002716;
	}
	else if (!wcsicmp(*rgszNames, L"Write")) {
		*rgDispId = 0x00002717;
	}
	else if (!wcsicmp(*rgszNames, L"WriteLine")) {
		*rgDispId = 0x00002718;
	}
	else if (!wcsicmp(*rgszNames, L"WriteBlankLines")) {
		*rgDispId = 0x00002719;
	}
	else if (!wcsicmp(*rgszNames, L"Skip")) {
		*rgDispId = 0x0000271a;
	}
	else if (!wcsicmp(*rgszNames, L"SkipLine")) {
		*rgDispId = 0x0000271b;
	}
	else if (!wcsicmp(*rgszNames, L"Close")) {
		*rgDispId = 0x0000271c;
	}
                                      ...
                                      EXCEPINFO *pExcepInfo, UINT *puArgErr)
{
	...
	switch(dispIdMember) {
		case 0x00002710: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				hr = textstream_get_Line(iface, (LONG*)&V_I4(pVarResult));
			}
			break;
		}
		case 0xfffffdef: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_I4;
				hr = textstream_get_Column(iface, (LONG*)&V_I4(pVarResult));
			}
			break;
		}
		case 0x00002712: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				hr = textstream_get_AtEndOfStream(iface, &V_BOOL(pVarResult));
			}
			break;
		}
		case 0x00002713: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_BOOL;
				hr = textstream_get_AtEndOfLine(iface, &V_BOOL(pVarResult));
			}
			break;
		}
		case 0x00002714: {
			if (wFlags & DISPATCH_METHOD) {
				...
				hr = textstream_Read(iface, V_I4(&var0), &V_BSTR(pVarResult));
				VariantClear(&var0);
			}
			break;
		}
		case 0x00002715: {
			if (wFlags & DISPATCH_METHOD) {
				...
				V_VT(pVarResult) = VT_BSTR;
				hr = textstream_ReadLine(iface, &V_BSTR(pVarResult));
			}
			break;
		}
		case 0x00002716: {
			if (wFlags & DISPATCH_METHOD) {
				...
				V_VT(pVarResult) = VT_BSTR;
				hr = textstream_ReadAll(iface, &V_BSTR(pVarResult));
			}
			break;
		}
		case 0x00002717: {
			if (wFlags & DISPATCH_METHOD) {
				...
				hr = textstream_Write(iface, V_BSTR(&var0));
				VariantClear(&var0);
			}
			break;
		}
		case 0x00002718: {
			if (wFlags & DISPATCH_METHOD) {
				...
				hr = textstream_WriteLine(iface, V_BSTR(&var0));
				VariantClear(&var0);
			}
			break;
		}
		case 0x00002719: {
			if (wFlags & DISPATCH_METHOD) {
				...
				V_VT(&var0) = VT_EMPTY;
				VariantChangeType(&var0, &pDispParams->rgvarg[--index], 0, VT_I4);
				hr = textstream_WriteBlankLines(iface, V_I4(&var0));
				VariantClear(&var0);
			}
			break;
		}
		case 0x0000271a: {
			if (wFlags & DISPATCH_METHOD) {
				...
				V_VT(&var0) = VT_EMPTY;
				VariantChangeType(&var0, &pDispParams->rgvarg[--index], 0, VT_I4);
				hr = textstream_Skip(iface, V_I4(&var0));
				VariantClear(&var0);
			}
			break;
		}
	...
	if (hr != S_OK) {
		if (dispIdMember == DISPID_VALUE && wFlags == (DISPATCH_METHOD | DISPATCH_PROPERTYGET)) {
			...
			printf("textstream_Invoke, dispId=%d (0x%08x), wFlags=%d, hr=%d", dispIdMember, dispIdMember, wFlags, hr);
		}
	}
	return hr;
#endif
                ...
                UINT cNames, LCID lcid, DISPID *rgDispId)
{
	...
	*rgDispId = DISPID_UNKNOWN;
	...
	if (!wcsicmp(*rgszNames, L"Name")) {
		*rgDispId = 0x000003e8;
	}
	else if (!wcsicmp(*rgszNames, L"ShortPath")) {
		*rgDispId = 0x000003ea;
	}
	else if (!wcsicmp(*rgszNames, L"ShortName")) {
		*rgDispId = 0x000003e9;
	}
	else if (!wcsicmp(*rgszNames, L"Drive")) {
		*rgDispId = 0x000003ec;
	}
	else if (!wcsicmp(*rgszNames, L"ParentFolder")) {
		*rgDispId = 0x000003ed;
	}
	else if (!wcsicmp(*rgszNames, L"Attributes")) {
		*rgDispId = 0x000003eb;
	}
	else if (!wcsicmp(*rgszNames, L"DateCreated")) {
		*rgDispId = 0x000003ee;
	}
	else if (!wcsicmp(*rgszNames, L"DateLastModified")) {
		*rgDispId = 0x000003ef;
	}
	else if (!wcsicmp(*rgszNames, L"DateLastAccessed")) {
		*rgDispId = 0x000003f0;
	}
	else if (!wcsicmp(*rgszNames, L"Size")) {
		*rgDispId = 0x000003f1;
	}
	else if (!wcsicmp(*rgszNames, L"Type")) {
		*rgDispId = 0x000003f2;
	}
	else if (!wcsicmp(*rgszNames, L"Delete")) {
		*rgDispId = 0x000004b0;
	}
	else if (!wcsicmp(*rgszNames, L"Copy")) {
		*rgDispId = 0x000004b2;
	}
	else if (!wcsicmp(*rgszNames, L"Move")) {
		*rgDispId = 0x000004b4;
	}
	else if (!wcsicmp(*rgszNames, L"OpenAsTextStream")) {
		*rgDispId = 0x0000044c;
	}
                                      ...
                                      EXCEPINFO *pExcepInfo, UINT *puArgErr)
{
	...
	switch(dispIdMember) {
		case DISPID_VALUE: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_BSTR;
				hr = file_get_Path(iface, &V_BSTR(pVarResult));
			}
			break;
		}
		case 0x000003e8: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_BSTR;
				hr = file_get_Name(iface, &V_BSTR(pVarResult));
			}
				...
				V_VT(&var0) = VT_EMPTY;
				VariantChangeType(&var0, &pDispParams->rgvarg[--index], 0, VT_BSTR);
				hr = file_put_Name(iface, V_BSTR(&var0));
				VariantClear(&var0);
			}
			break;
		}
		case 0x000003ea: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_BSTR;
				hr = file_get_ShortPath(iface, &V_BSTR(pVarResult));
			}
			break;
		}
		case 0x000003e9: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_BSTR;
				hr = file_get_ShortName(iface, &V_BSTR(pVarResult));
			}
			break;
		}
		case 0x000003ec: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_DISPATCH;
				hr = file_get_Drive(iface, (IDrive**)&V_DISPATCH(pVarResult));
			}
			break;
		}
		case 0x000003ed: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_DISPATCH;
				hr = file_get_ParentFolder(iface, (IFolder**)&V_DISPATCH(pVarResult));
			}
			break;
		}
		case 0x000003eb: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_I4;
				hr = file_get_Attributes(iface, (FileAttribute*)&V_I4(pVarResult));
			}
			else if (wFlags & DISPATCH_PROPERTYPUT) {
				...
				V_VT(&var0) = VT_EMPTY;
				VariantChangeType(&var0, &pDispParams->rgvarg[--index], 0, VT_I4);
				hr = file_put_Attributes(iface, (FileAttribute)V_I4(&var0));
				VariantClear(&var0);
			}
			break;
		}
		case 0x000003ee: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				hr = file_get_DateCreated(iface, &V_DATE(pVarResult));
			}
			break;
		}
		case 0x000003ef: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_DATE;
				hr = file_get_DateLastModified(iface, &V_DATE(pVarResult));
			}
			break;
		}
		case 0x000003f0: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_DATE;
				hr = file_get_DateLastAccessed(iface, &V_DATE(pVarResult));
			}
			break;
		}
		case 0x000003f1: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				hr = file_get_Size(iface, pVarResult);
			}
			break;
		}
		case 0x000003f2: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(pVarResult) = VT_BSTR;
				hr = file_get_Type(iface, &V_BSTR(pVarResult));
			}
			break;
		}
		case 0x000004b0: {
			if (wFlags & DISPATCH_METHOD) {
				...
				hr = file_Delete(iface, V_BOOL(&var0));
				VariantClear(&var0);
			}
			break;
		}
		case 0x000004b2: {
			if (wFlags & DISPATCH_METHOD) {
				...
				hr = file_Copy(iface, V_BSTR(&var0), V_BOOL(&var1));
				VariantClear(&var0);
				VariantClear(&var1);
			}
			break;
		...
		case 0x000004b4: {
			if (wFlags & DISPATCH_METHOD) {
				...
				V_VT(&var0) = VT_EMPTY;
				VariantChangeType(&var0, &pDispParams->rgvarg[--index], 0, VT_BSTR);
				hr = file_Move(iface, V_BSTR(&var0));
				VariantClear(&var0);
			}
			break;
		}
		case 0x0000044c: {
			if (wFlags & DISPATCH_METHOD) {
				...
				V_VT(pVarResult) = VT_DISPATCH;
				hr = file_OpenAsTextStream(iface, (IOMode)V_I4(&var0), (Tristate)V_I4(&var1), (ITextStream**)&V_DISPATCH(pVarResult));
				VariantClear(&var0);
				VariantClear(&var1);
			}
			break;
	...
	if (hr != S_OK) {
		if (dispIdMember == DISPID_VALUE && wFlags == (DISPATCH_METHOD | DISPATCH_PROPERTYGET)) {
			...
			printf("file_Invoke, dispId=%d (0x%08x), wFlags=%d, hr=%d", dispIdMember, dispIdMember, wFlags, hr);
		}
	}
	return hr;
#endif
...
#else
    f->path = malloc((len+1)*sizeof(WCHAR));
#endif
...
#ifndef __STANDALONE__
    memset(f->path, 0, (len+1)*sizeof(WCHAR))
#endif
                                      ...
                                      EXCEPINFO *pExcepInfo, UINT *puArgErr)
{
	...
	if (hr != S_OK) {
		if (dispIdMember == DISPID_VALUE && wFlags == (DISPATCH_METHOD | DISPATCH_PROPERTYGET)) {
			...
			printf("filesys_Invoke, dispId=%d (0x%08x), wFlags=%d, hr=%d", dispIdMember, dispIdMember, wFlags, hr);
		}
	}
	return hr;
#endif
