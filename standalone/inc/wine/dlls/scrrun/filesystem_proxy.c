                                      ...
                                      EXCEPINFO *pExcepInfo, UINT *puArgErr)
{
	...
	if (hres == S_OK) {
		...
		external_log_info("drive_Invoke: dispId=%d (0x%08x), wFlags=%d, hres=%d\n", dispIdMember, dispIdMember, wFlags, hres);
	}
	return hres;
}
                                      ...
                                      EXCEPINFO *pExcepInfo, UINT *puArgErr)
{
	...
	if (hres == S_OK) {
		...
		external_log_info("drivecoll_Invoke: dispId=%d (0x%08x), wFlags=%d, hres=%d\n", dispIdMember, dispIdMember, wFlags, hres);
	}
	return hres;
}
                                      ...
                                      EXCEPINFO *pExcepInfo, UINT *puArgErr)
{
	...
	if (hres == S_OK) {
		...
		external_log_info("textstream_Invoke: dispId=%d (0x%08x), wFlags=%d, hres=%d\n", dispIdMember, dispIdMember, wFlags, hres);
	}
	return hres;
}
                                      ...
                                      EXCEPINFO *pExcepInfo, UINT *puArgErr)
{
	...
	if (hres == S_OK) {
		...
		external_log_info("file_Invoke: dispId=%d (0x%08x), wFlags=%d, hres=%d\n", dispIdMember, dispIdMember, wFlags, hres);
	}
	return hres;
}
                                      ...
                                      EXCEPINFO *pExcepInfo, UINT *puArgErr)
{
	...
	if (hres == S_OK) {
		...
		external_log_info("filesys_Invoke: dispId=%d (0x%08x), wFlags=%d, hres=%d\n", dispIdMember, dispIdMember, wFlags, hres);
	}
	return hres;
}
                                      ...
                                      EXCEPINFO *pExcepInfo, UINT *puArgErr)
{
	...
	if (hres == S_OK) {
		...
		external_log_info("foldercoll_Invoke: dispId=%d (0x%08x), wFlags=%d, hres=%d\n", dispIdMember, dispIdMember, wFlags, hres);
	}
	return hres;
}
                                      ...
                                      EXCEPINFO *pExcepInfo, UINT *puArgErr)
{
	...
	if (hres == S_OK) {
		...
		external_log_info("folder_Invoke: dispId=%d (0x%08x), wFlags=%d, hres=%d\n", dispIdMember, dispIdMember, wFlags, hres);
	}
	return hres;
}