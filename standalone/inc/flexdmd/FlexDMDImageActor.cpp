...
#include "../system_drawing_common/Bitmap.h"
...
STDMETHODIMP FlexDMDImageActor::put_x(single pRetVal)
{
    return S_OK;
}
...
STDMETHODIMP FlexDMDImageActor::put_y(single pRetVal)
{
    return S_OK;
}
...
STDMETHODIMP FlexDMDImageActor::put_Width(single pRetVal)
{
    return S_OK;
}
...
STDMETHODIMP FlexDMDImageActor::put_Height(single pRetVal)
{
    return S_OK;
}
...
STDMETHODIMP FlexDMDImageActor::get_ActionFactory(IActionFactory **pRetVal)
{
