...
STDMETHODIMP FlexDMDVideoActor::put_x(single pRetVal)
{
    return S_OK;
}
...
STDMETHODIMP FlexDMDVideoActor::put_y(single pRetVal)
{
    return S_OK;
}
...
STDMETHODIMP FlexDMDVideoActor::put_Width(single pRetVal)
{
    return S_OK;
}
...
STDMETHODIMP FlexDMDVideoActor::put_Height(single pRetVal)
{
    return S_OK;
}
...
STDMETHODIMP FlexDMDVideoActor::SetBounds(single x, single y, single Width, single Height)
{
    return S_OK;
}

STDMETHODIMP FlexDMDVideoActor::SetPosition(single x, single y)
{
    return S_OK;
}

STDMETHODIMP FlexDMDVideoActor::SetAlignedPosition(single x, single y, Alignment alignment)
{
    return S_OK;
}

STDMETHODIMP FlexDMDVideoActor::SetSize(single Width, single Height)
{
    return S_OK;
}
...
STDMETHODIMP FlexDMDVideoActor::get_ActionFactory(IActionFactory **pRetVal)
{
