...
STDMETHODIMP FlexDMDGroupActor::put_x(single pRetVal)
{
    return S_OK;
}
...
STDMETHODIMP FlexDMDGroupActor::put_y(single pRetVal)
{
    return S_OK;
}
...
STDMETHODIMP FlexDMDGroupActor::put_Width(single pRetVal)
{
    return S_OK;
}
...
STDMETHODIMP FlexDMDGroupActor::put_Height(single pRetVal)
{
    return S_OK;
}
...
STDMETHODIMP FlexDMDGroupActor::put_visible(VARIANT_BOOL pRetVal)
{
    return S_OK;
}
...
STDMETHODIMP FlexDMDGroupActor::SetBounds(single x,single y,single Width,single Height)
{
    return S_OK;
}
STDMETHODIMP FlexDMDGroupActor::SetPosition(single x,single y)
{
    return S_OK;
}
STDMETHODIMP FlexDMDGroupActor::SetAlignedPosition(single x, single y, Alignment alignment) { return E_NOTIMPL; }
STDMETHODIMP FlexDMDGroupActor::SetSize(single Width,single Height)
{
    return S_OK;
}
...
STDMETHODIMP FlexDMDGroupActor::get_ActionFactory(IActionFactory **pRetVal)
{
    return m_pActionFactory->QueryInterface(IID_IActionFactory, (void**)pRetVal);
}

STDMETHODIMP FlexDMDGroupActor::AddAction(IUnknown *action)
{
    return S_OK;
}
