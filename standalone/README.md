...
For STIdx = 0 to UBound(STArray)
   STArray0(STIdx) = STArray(STIdx)(0)
   STArray1(STIdx) = STArray(STIdx)(1)
...
- `STArray(i)(0)` to `STArray0(i)`  `:%s/STArray(i)(0)/STArray0(i)/g`
- `STArray(i)(1)` to `STArray1(i)`  `:%s/STArray(i)(1)/STArray1(i)/g`
- `STArray(i)(2)` to `STArray2(i)`  `:%s/STArray(i)(2)/STArray2(i)/g`
- `STArray(i)(3)` to `STArray3(i)`  `:%s/STArray(i)(3)/STArray3(i)/g`
