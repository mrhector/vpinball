...
- The `PinMAMEPath` entry in the `[Standalone]` section of `VPinballX.ini` can be used to override `$HOME/.pinmame`
...
* 06/14/23
  ...
  * Move `SDL_Surface` from `FlexDMDImageActor` to `FlexDMDBitmap` to support copying
