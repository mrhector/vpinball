...
public:
   ...
   using RenderCallback = std::function<void(SDL_Renderer* pRenderer)>;

   SDL_Window* m_pB2SBackglassWindow;
   SDL_Renderer* m_pB2SBackglassRenderer;
   void SetB2SBackglassRenderCallback(RenderCallback callback);

   SDL_Window* m_pB2SDMDWindow;
   SDL_Renderer* m_pB2SDMDRenderer;
   void SetB2SDMDRenderCallback(RenderCallback callback);

   SDL_Window* m_pDMDWindow;
   SDL_Renderer* m_pDMDRenderer;
   void SetDMDRenderCallback(RenderCallback callback);
#endif

#ifdef __STANDALONE__
private:
   RenderCallback m_b2sBackglassRenderCallback;
   RenderCallback m_b2sDMDRenderCallback;
   RenderCallback m_dmdRenderCallback;
#endif
