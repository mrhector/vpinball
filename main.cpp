...
public:
   ...
   BOOL InitInstance() override
   {
      ...
      copy_folder("assets", m_vpinball.m_szMyPrefPath.c_str());
#endif
#endif
      ...
      const string launchTable = LoadValueWithDefault(regKey[RegName::Player], "LaunchTable"s, "res/exampleTable.vpx"s);
