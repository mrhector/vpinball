...
#else
   PLOGI.printf("col_is_linear=%d, comp_format: %s (0x%04x), col_format=%s (0x%04x), col_type=%s (0x%04x)",
          col_is_linear, 
          glToString(comp_format), comp_format,
          glToString(col_format), col_format,
          glToString(col_type), col_type);
#endif
